...
function Uc(e, n, t, r, l, u, o, i, s) {
  (Et = !1), (Tr = null), Fc.apply(jc, arguments);
}
...
var Ir = null;
function au(e, n, t, r) {
  if (((Ir = null), (e = Xu(r)), (e = Sn(e)), e !== null))
  ...
  nl = A({}, Gt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== pt &&
            (pt && e.type === "mousemove"
              ? ((_l = e.screenX - pt.screenX), (xl = e.screenY - pt.screenY))
              : (xl = _l = 0),
            (pt = e)),
          _l);
    },
...
function As(e) {
  if (e.propertyName === "value" && tl(Ft)) {
    var n = [];
    Us(n, Ft, e, Xu(e)), ws(Rf, n);
  }
}
function Mf(e, n, t) {
  e === "focusin"
    ? (ri(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", As))
    : e === "focusout" && ri();
}
function Df(e) {
    ...
    if (!(n & 7)) {
      ...
      P &&
        ...
        0 < _.length &&
          ...
          x ? (P.data = x) : ((x = js(t)), x !== null && (P.data = x)))),
        (x = Nf ? zf(e, t) : Lf(e, t)) &&
...
function vn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(Gu, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function bs(e, n, t) {
  (we[Se++] = Ve), (we[Se++] = Be), (we[Se++] = Pn), (Pn = e);
  var r = Ve;
  e = Be;
  var l = 32 - Te(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function oa(e) {
  ...
  function S(f, a, d, h) {
    ...
    if (T.done) return t(f, x), j && gn(f, P), E;
    if (x === null) {
      for (; !T.done; P++, T = d.next())
        (T = m(f, T.value, h)),
          T !== null &&
            ((a = u(T, a, P)), _ === null ? (E = T) : (_.sibling = T), (_ = T));
      return j && gn(f, P), E;
    }
...
function Sa(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), il(4, 4, wa.bind(null, n, e), t)
  );
}
function So() {}
function ka(e, n) {
...
function Ca(e, n, t) {
  return Nn & 21
    ? (Oe(t, n) || ((t = Ps()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function nd(e, n, t) {
  ...
  if (xa(e)) Pa(n, l);
    ...
    (t = ta(e, n, l, r)),
      t !== null && ((l = ue()), Re(t, e, r, l), Na(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
var Yr = {
  ...
  td = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        (l.queue = u),
        Ci(pa.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Qt(9, da.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Li(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), ua(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
    ...
    (o.state = p),
      ...
      i !== r || p !== s || ce.current || Je
        ? (typeof v == "function" && (ku(n, t, v, r), (s = n.memoizedState)),
...
function id(e, n, t, r, l, u, o) {
  ...
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    ...
    return No(), (r = Al(Error(y(421)))), pr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
        ...
        (e === null || e.child === null) &&
          (fr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Fu(Le), (Le = null)))),
        zu(e, n),
        ne(n),
        null
      );
    ...
    case 13:
      if (
        ...
        if (j && me !== null && n.mode & 1 && !(n.flags & 128))
          ...
          ne(n), (u = !1);
        } else Le !== null && (Fu(Le), (Le = null)), (u = !0);
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[hu], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = vu(wn.bind(null, e, se, $e), n);
            break;
          }
          wn(e, se, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = vu(wn.bind(null, e, se, $e), r);
            break;
          }
          wn(e, se, $e);
          break;
...
function No() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(zn & 268435455) && !(al & 268435455)) || be(Z, q);
}
function Jr(e, n) {
  var t = R;
  R |= 2;
...
Za = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && bs(n, Vr, n.index);
...
function zr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) zo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Kl:
        return (
          (e = ke(12, t, n, l | 2)), (e.elementType = Kl), (e.lanes = u), e
        );
      case Yl:
        return (e = ke(13, t, n, l)), (e.elementType = Yl), (e.lanes = u), e;
      case Xl:
        return (e = ke(19, t, n, l)), (e.elementType = Xl), (e.lanes = u), e;
      case os:
        return cl(t, l, u, n);
      default:
  ...
  return (
    (n = ke(o, t, n, l)), (n.elementType = e), (n.type = r), (n.lanes = u), n
  );
}
function _n(e, n, t, r) {
...
ys = xo;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, vs, hs, xo] },
  ht = {
...
ye.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = ba(n, null, e, 1, t ?? null, l, !1, u, o)),
    (e[Qe] = n.current),
    Ut(e),
    r)
  )
...
const Od = () =>
    Fe.jsxs("div", {
      className: "container",
      children: [Fe.jsx(Md, {}), Fe.jsx(Dd, {})],
    }),
  Md = () => {
    let e = new Date();
    return Fe.jsx("div", {
      className: "time",
      children: Fe.jsxs("p", { children: [e.getHours(), ":", e.getMinutes()] }),
    });
  },
  Dd = () => {
    let e = "null",
    ...
    return (
      n.getHours() < 12
        ? (e = "Bom dia")
        : n.getHours() >= 12 && n.getHours() < 18
        ? (e = "Boa tarde")
        : (e = "Boa noite"),
      Fe.jsx("div", {
        className: "greeting",
        children: Fe.jsx("p", { children: e }),
      })
    );
  };
Wl.createRoot(document.getElementById("root")).render(
  Fe.jsx(wc.StrictMode, { children: Fe.jsx(Rd, {}) })
);
